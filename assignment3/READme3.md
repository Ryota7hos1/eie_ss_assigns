...
5. [Major Problems Encountered and Solutions](#major-problems-encountered-and-solutions)  
6. [Stress Test - Comparing Fit Strategy + Merging](#stress-testing)
7. [Build & Run Instructions](#build-and-run)  
...
We have fully implemeted each of the required 3 stages and tested that it works accurately.
...
| **Freelist Length** | **Very Long** | **Long** | **Very Short** (Blocks are combined) |
